...
#define SCC8660_COLOR_MODE_DEF  (1  )                                           // 图像色彩模式 默认：1         可选参数为：[0,1] 0：正常彩色模式   1：鲜艳模式（色彩饱和度提高）
#define SCC8660_DATA_FORMAT_DEF (1  )                                           // 输出数据格式 默认：1         可选参数为：[0-3] 0：RGB565 1：RGB565(字节交换) 2：YUV422(YUYV) 3：YUV422(UYVY)
